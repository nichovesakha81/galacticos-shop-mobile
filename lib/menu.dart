...
class MyHomePage extends StatelessWidget {
  ...
  final String nama = "Nicholas Vesakha";
  final String npm = "2406495804";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // Judul aplikasi "Galacticos Shop" dengan teks putih dan tebal.
        title: const Text(
          'Galacticos Shop',
          style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),
        ),
        // Warna latar belakang AppBar diubah jadi amber (mirip emas).
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Selamat datang di Galacticos Shop',
                      style: TextStyle(
